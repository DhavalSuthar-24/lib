...
import { ADMIN_STRATEGY, EXTERN_USER_REQ_PROP } from '../constants';
import { AdminAuthOptions } from '../options';

@Injectable()
export class AdminJwtStrategy extends PassportStrategy(Strategy, ADMIN_STRATEGY) {
